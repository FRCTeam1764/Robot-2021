...
public class PIDConstants {
	...
	public static final double TALON_VELOCITY_PER_ROBOT_VELOCITY = /*input of ticks/100ms*/ (1000.0)/CLICKS_PER_INCH; //Ticks/100ms per inches/second
	public static final double TALON_VELOCITY_PER_RPM = (1.0/100)*1000.0*60.0/2048.0; //Ticks/100ms per Rev/min
