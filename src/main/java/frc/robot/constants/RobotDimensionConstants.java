...
public class RobotDimensionConstants {
    ...
    public static final double GEAR_BOX_RATIO = (52.0/12.0)*(52.0/22.0);
    
    public static final double LIMELIGHT_CAMERA_ANGLE = 20; //20, 45, 60 degrees are also an option
    public static final double LIMELIGHT_HEIGHT_FROM_GROUND = 18.31;
