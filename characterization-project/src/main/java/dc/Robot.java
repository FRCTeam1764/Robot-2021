...
public class Robot extends TimedRobot {
  ...
  static private double GEARING = 10.24;
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_TalonFX leftMotor = setupWPI_TalonFX(34, Sides.LEFT, false);

    WPI_TalonFX leftFollowerID35 = setupWPI_TalonFX(35, Sides.FOLLOWER, false);
    leftFollowerID35.follow(leftMotor);
    WPI_TalonFX leftFollowerID36 = setupWPI_TalonFX(36, Sides.FOLLOWER, false);
    leftFollowerID36.follow(leftMotor);

    WPI_TalonFX rightMotor = setupWPI_TalonFX(31, Sides.RIGHT, false);
    WPI_TalonFX rightFollowerID32 = setupWPI_TalonFX(32, Sides.FOLLOWER, false);    
    rightFollowerID32.follow(rightMotor);
    WPI_TalonFX rightFollowerID33 = setupWPI_TalonFX(33, Sides.FOLLOWER, false);    
    rightFollowerID33.follow(rightMotor);
